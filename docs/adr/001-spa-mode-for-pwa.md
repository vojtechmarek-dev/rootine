...
- **Loss of SEO:** The application will not be properly indexed by search engines. _Mitigation: This is acceptable because Rootine is a private, authenticated personal productivity tool._
- **Requires JavaScript:** Users with JavaScript disabled cannot use the app. _Mitigation: Modern PWAs fundamentally require JavaScript, so this is an accepted baseline requirement._
