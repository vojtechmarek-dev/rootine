...
<div class="flex min-h-screen flex-col bg-background">
	...
	<nav
		class="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-card shadow-lg dark:border-border dark:bg-card"
		aria-label="Main navigation"
	>
		<div class="mx-auto flex max-w-screen-xl items-center justify-around px-4 py-2">
